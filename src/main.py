...
def main():
    ...
    parser.add_argument(
        "prompt", type=str, help="Natural language description of the app to build"
    )
    ...
    parser.add_argument(
        "--dry-run", action="store_true", help="Generate code without building"
    )
    ...
    if args.verbose:
        print("NaturalPromptXcode - Building iOS app from prompt")
    ...
    try:
        ...
        project_path = builder.create_project(
            project_structure, output_dir=args.output_dir
        )
